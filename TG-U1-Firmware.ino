...
#define virtual_Buttons 128                     // (Max 128) How many buttons will show in a game etc
...
String  Encoder1_Type = "Absolute";             // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder1_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder2_Type = "Incremental";          // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder2_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder3_Type = "Incremental";          // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder3_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder4_Type = "Incremental";          // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder4_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder5_Type = "Absolute";             // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder5_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder6_Type = "Incremental";          // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder6_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder7_Type = "Incremental";          // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder7_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
...
String  Encoder8_Type = "Incremental";          // Incremental for 2 outputs(clockwise and anti-clockwise) or Absolute(virtual rotary switch)
#define Encoder8_Absolute_Pos 12                // How many virtual positions the switch will have Absolute(virtual rotary switch)
